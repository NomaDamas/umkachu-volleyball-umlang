...
def write_report(rows):
    ...
    lines = [
        "# Umlang Runtime Benchmarks",
        "",
        "Generated by `tools/bench_umlang_runtimes.py`.",
        "",
        '<p align="center">',
        '  <img src="umlang-throughput.svg" alt="Umlang runtime throughput benchmark graph">',
        "</p>",
        '<p align="center"><em>Figure 1. Umlang VM throughput by runner: Rust, Node.js, and Python-style implementations.</em></p>',
        "",
        '<p align="center">',
        '  <img src="umlang-total-latency.svg" alt="Umlang runtime total latency benchmark graph">',
        "</p>",
        '<p align="center"><em>Figure 2. Umlang VM total latency by runner: parse + lazy compile + execute.</em></p>',
        "",
        "## Method",
        "",
