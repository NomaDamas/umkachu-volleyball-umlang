...
| [What is Umlang?](#-What-is-Umlang?) | 엄랭 밈/언어 배경과 이 실행기의 해석 방식. |
| [Quick Start](#-quick-start) | 전체 `.umm` 패키지와 작은 코어 샘플 실행. |
| [Core of Umkachu](#-Core-of-Umkachu) | 전체 게임이 쓰는 최소 실행 패턴. |
...
이 샘플은 설명용 pseudocode가 아니라 실제 Umkachu volleyball의 엄랭 소스입니다.
